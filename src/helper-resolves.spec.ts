...
const getEventSourceMapping = jest.fn().mockImplementation(() => {
    return Promise.resolve<Lambda.EventSourceMappingConfiguration>(eventSourceMappingConfigurationResponse);
});
...
const invokeAsync = jest.fn().mockImplementation(() => {
    return Promise.resolve<Lambda.InvokeAsyncResponse>(invokeAsyncResponseResponse);
});
const listEventSourceMappings = jest.fn().mockImplementation(() => {
    return Promise.resolve<Lambda.ListEventSourceMappingsResponse>(listEventSourceMappingsResponseResponse);
});
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.DisableDynamoEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.DisableDynamoEventSourceMappingAsync(TestValues.EmptyString,
            TestValues.Uuid);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.DisableDynamoEventSourceMappingAsync(TestValues.Name,
    ...
    test(TestValues.ValidTest, () => {
        const actual = lambdaHelperMock.DisableDynamoEventSourceMappingAsync(TestValues.Name,
            TestValues.Uuid);
        return expect(actual).resolves.toEqual(eventSourceMappingConfigurationResponse);
    });
});
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.DisableKinesisEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.DisableKinesisEventSourceMappingAsync(TestValues.EmptyString,
            TestValues.Uuid);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.DisableKinesisEventSourceMappingAsync(TestValues.Name,
            TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uuid`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.DisableSQSEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.DisableSQSEventSourceMappingAsync(TestValues.EmptyString,
            TestValues.Uuid);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.DisableSQSEventSourceMappingAsync(TestValues.Name,
            TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uuid`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.EnableDynamoEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.EnableDynamoEventSourceMappingAsync(TestValues.EmptyString,
            TestValues.Uuid);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.EnableDynamoEventSourceMappingAsync(TestValues.Name,
            TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uuid`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.EnableKinesisEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.EnableKinesisEventSourceMappingAsync(TestValues.EmptyString,
            TestValues.Uuid);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.EnableKinesisEventSourceMappingAsync(TestValues.Name,
            TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uuid`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.EnableSQSEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.EnableSQSEventSourceMappingAsync(TestValues.EmptyString,
            TestValues.Uuid);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.EnableSQSEventSourceMappingAsync(TestValues.Name,
            TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uuid`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.GetEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.GetEventSourceMappingAsync(TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uuid`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.ListEventSourceMappingsAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.ListEventSourceMappingsAsync(TestValues.EmptyString,
            TestValues.Arn);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(`${TestValues.ThrowsOnEmpty} eventSourceArn`, () => {
        const actual = lambdaHelperMock.ListEventSourceMappingsAsync(TestValues.Name,
            TestValues.EmptyString);
    ...
    test(TestValues.ValidTest, () => {
        const actual = lambdaHelperMock.ListEventSourceMappingsAsync(TestValues.Name,
            TestValues.Arn);
        return expect(actual).resolves.toEqual(listEventSourceMappingsResponseResponse);
    });
});
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.InvokeSync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.InvokeSync<string>(TestValues.EmptyString,
            TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(TestValues.ValidTest, () => {
        const actual = lambdaHelperMock.InvokeSync<string>(TestValues.Name,
            TestValues.Body);
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.InvokeAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.InvokeAsync<string>(TestValues.EmptyString,
            TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} functionName`);
    });
    test(TestValues.ValidTest, () => {
        const actual = lambdaHelperMock.InvokeAsync<string>(TestValues.Name,
            TestValues.Body);
        return expect(actual).resolves.toEqual(invocationResponseResponse);
    });
});
...
describe(`${LambdaHelper.name}.${lambdaHelperMock.UpdateEventSourceMappingAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} functionName`, () => {
        const actual = lambdaHelperMock.UpdateEventSourceMappingAsync(TestValues.EmptyString,
    ...
    test(`${TestValues.ThrowsOnEmpty} uuid`, () => {
        const actual = lambdaHelperMock.UpdateEventSourceMappingAsync(TestValues.Name,
            TestValues.BooleanValue,
            TestValues.EmptyString,
            TestValues.NumberValue);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uuid`);
